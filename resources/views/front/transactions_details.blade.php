...
<body>
  ...
  <main class="bg-[#FAFAFA] max-w-[640px] mx-auto min-h-screen relative flex flex-col has-[#CTA-nav]:pb-[120px] has-[#Bottom-nav]:pb-[120px]">
        ...
        <div id="Location" class="flex flex-col gap-2">
          ...
          <div class="flex items-center w-full gap-[10px] bg-white">
            ...
            <div class="flex flex-col">
              <div class="flex items-center gap-1">
                <p class="font-semibold w-fit">{{ Storage::url($details->store_details->name) }}</p>
                <div class="w-[18px] h-[18px] flex shrink-0">
                  <img src="{{asset('assets/images/icons/verify.svg')}}" alt="verified">
                </div>
              </div>
    ...
    <div class="px-8 mt-[30px] flex">
      <a href="index.html" class="w-full rounded-full p-[12px_20px] bg-[#FF8E62] font-bold text-white text-center">Call Customer Service</a>
    </div>
  </main>
</body>
</html>